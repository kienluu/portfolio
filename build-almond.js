({
    ...
    //If out is not used we cannot use dir and appDir
    //"appDir" is not compatible with "out". Use "dir" instead.
    //appDir is used to copy whole projects, where "out" is used to just optimize to one file.
    out: 'webapp/js/main-optimized.js',
